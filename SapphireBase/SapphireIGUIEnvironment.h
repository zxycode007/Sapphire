#ifndef _SAPPHIRE_I_GUI_ENVIRONMENT_
#define _SAPPHIRE_I_GUI_ENVIRONMENT_
...
namespace Sapphire
{
	...
	*/
	class IGUIEnvironment : public virtual IReferenceCounter
	{
	public:
		...
		*/
		...
		This pointer should not be dropped. See IReferenceCounted::drop() for
		more information. */
		virtual IGUIFont* getFont(const path& filename) = 0;
		...
		virtual IGUIFont* addFont(const path& name, IGUIFont* font) = 0;
		...
		virtual IGUISpriteBank* getSpriteBank(const path& filename) = 0;

		//! Adds an empty sprite bank to the manager
		/** \param name Name of the new sprite bank.
		\return Pointer to the sprite bank.
		This pointer should not be dropped. See IReferenceCounted::drop() for more information. */
		virtual IGUISpriteBank* addEmptySpriteBank(const path& name) = 0;
		...
		This pointer should not be dropped. See IReferenceCounted::drop() for
		more information. */
		virtual IGUIButton* addButton(const rect<SINT32>& rectangle,
			IGUIElement* parent = 0, SINT32 id = -1, const wchar_t* text = 0, const wchar_t* tooltiptext = 0) = 0;
		...
		virtual IGUIWindow* addWindow(const rect<SINT32>& rectangle, bool modal = false,
			const wchar_t* text = 0, IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		virtual IGUIWindow* addMessageBox(const wchar_t* caption, const wchar_t* text = 0,
			bool modal = true, SINT32 flags = EMBF_OK, IGUIElement* parent = 0, SINT32 id = -1, ITexture* image = 0) = 0;
		...
		virtual IGUIScrollBar* addScrollBar(bool horizontal, const rect<SINT32>& rectangle,
			IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		virtual IGUIImage* addImage(ITexture* image, Position2d pos,
			bool useAlphaChannel = true, IGUIElement* parent = 0, SINT32 id = -1, const wchar_t* text = 0) = 0;
		...
		virtual IGUIImage* addImage(const rect<SINT32>& rectangle,
			IGUIElement* parent = 0, SINT32 id = -1, const wchar_t* text = 0, bool useAlphaChannel = true) = 0;
		...
		occurred. This pointer should not be dropped. See
		IReferenceCounted::drop() for more information. */
		virtual IGUICheckBox* addCheckBox(bool checked, const rect<SINT32>& rectangle,
			IGUIElement* parent = 0, SINT32 id = -1, const wchar_t* text = 0) = 0;
		...
		virtual IGUIListBox* addListBox(const rect<SINT32>& rectangle,
			IGUIElement* parent = 0, SINT32 id = -1, bool drawBackground = false) = 0;
		...
		occurred. This pointer should not be dropped. See
		IReferenceCounted::drop() for more information. */
		virtual IGUIMeshViewer* addMeshViewer(const rect<SINT32>& rectangle,
			IGUIElement* parent = 0, SINT32 id = -1, const wchar_t* text = 0) = 0;
		...
		virtual IGUIColorSelectDialog* addColorSelectDialog(const wchar_t* title = 0,
			bool modal = true, IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		virtual IGUIStaticText* addStaticText(const wchar_t* text, const rect<SINT32>& rectangle,
			bool border = false, bool wordWrap = true, IGUIElement* parent = 0, SINT32 id = -1,
		...
		virtual IGUIEditBox* addEditBox(const wchar_t* text, const rect<SINT32>& rectangle,
			bool border = true, IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		occurred. This pointer should not be dropped. See
		IReferenceCounted::drop() for more information. */
		virtual IGUIInOutFader* addInOutFader(const rect<SINT32>* rectangle = 0, IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		virtual IGUITabControl* addTabControl(const rect<SINT32>& rectangle,
			...
			bool border = true, SINT32 id = -1) = 0;
		...
		error occurred. This pointer should not be dropped. See
		IReferenceCounted::drop() for more information. */
		virtual IGUIContextMenu* addMenu(IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		error occurred. This pointer should not be dropped. See
		IReferenceCounted::drop() for more information. */
		virtual IGUIToolBar* addToolBar(IGUIElement* parent = 0, SINT32 id = -1) = 0;
		...
		virtual UINT32 getRegisteredGUIElementFactoryCount() const = 0;
		...
		virtual IGUIElementFactory* getGUIElementFactory(UINT32 index) const = 0;
		...
		virtual bool saveGUI(const path& filename, IGUIElement* start = 0) = 0;

		//! Saves the current gui into a file.
		/** \param file The file to write to.
		\param start The GUIElement to start with. Root if 0.
		\return True if saving succeeded, else false. */
		virtual bool saveGUI(IWriteFile* file, IGUIElement* start = 0) = 0;
		...
		virtual bool loadGUI(const path& filename, IGUIElement* parent = 0) = 0;
		...
		\param parent Parent for the loaded GUI, root if 0.
		\return True if loading succeeded, else false. */
		virtual bool loadGUI(IReadFile* file, IGUIElement* parent = 0) = 0;

		//! Writes attributes of the gui environment
		virtual void serializeAttributes(IAttributes* out, SAttributeReadWriteOptions* options = 0) const = 0;

		//! Reads attributes of the gui environment
		virtual void deserializeAttributes(IAttributes* in, SAttributeReadWriteOptions* options = 0) = 0;

		//! writes an element
		virtual void writeGUIElement(IXMLWriter* writer, IGUIElement* node) = 0;

		//! reads an element
		virtual void readGUIElement(IXMLReader* reader, IGUIElement* node) = 0;
	};
