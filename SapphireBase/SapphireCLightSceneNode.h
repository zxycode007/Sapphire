#ifndef _SAPPHIRE_C_LIGHT_SCENE_NODE_
#define _SAPPHIRE_C_LIGHT_SCENE_NODE_
...
namespace Sapphire
{
	...
	public:
		...
		//! constructor
		CLightSceneNode(ISceneNode* parent, ISceneManager* mgr, SINT32 id,
			const Vector3& position, ColourValue color, FLOAT32 range);
		...
		virtual void setLightData(const SLight& light);

		//! \return Returns the light data.
		virtual const SLight& getLightData() const;

		//! \return Returns the light data.
		virtual SLight& getLightData();
		...
		virtual void setLightType(E_LIGHT_TYPE type);

		//! Gets the light type.
		/** \return The current light type. */
		virtual E_LIGHT_TYPE getLightType() const;
