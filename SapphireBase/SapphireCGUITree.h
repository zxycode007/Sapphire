#ifndef _SAPPHIRE_C_GUI_TREE_
#define _SAPPHIRE_C_GUI_TREE_
...
namespace Sapphire
{
	...
	public:
		...
		virtual UINT32 getImageIndex() const
		{
			return ImageIndex;
		}

		//! sets the image index of the node
		virtual void setImageIndex(UINT32 imageIndex)
		{
			ImageIndex = imageIndex;
		}

		//! returns the image index of the node
		virtual UINT32 getSelectedImageIndex() const
		{
			return SelectedImageIndex;
		}

		//! sets the image index of the node
		virtual void setSelectedImageIndex(UINT32 imageIndex)
		{
		...
		//! returns the user data2 (IReferenceCounter) of this node
		virtual IReferenceCounter* getData2() const
		{
			return Data2;
		}

		//! sets the user data2 (IReferenceCounter) of this node
		virtual void setData2(IReferenceCounter* data)
		{
			if (Data2)
			{
				Data2->drop();
		...
		//! \param data2 user data2 (IReferenceCounter*) of the new node
		//! \return
	...
	private:
		...
		StringW			Icon;
		SINT32				ImageIndex;
		SINT32				SelectedImageIndex;
		void*				Data;
		IReferenceCounter*		Data2;
		bool				Expanded;
		list<CGUITreeViewNode*>::type	Children;
	};
	...
	private:
		...
		void mouseAction(SINT32 xpos, SINT32 ypos, bool onlyHover = false);
