#ifndef _SAPPHIRE_I_GUI_SKIN_
#define _SAPPHIRE_I_GUI_SKIN_
...
namespace Sapphire
{
	...
	*/
	...
	class IGUISkin : public virtual IAttributeExchangingObject
	{
	public:

		//! returns default color
		virtual ColourValue getColor(EGUI_DEFAULT_COLOR color) const = 0;

		//! sets a default color
		virtual void setColor(EGUI_DEFAULT_COLOR which, ColourValue newColor) = 0;

		//! returns size for the given size type
		virtual SINT32 getSize(EGUI_DEFAULT_SIZE size) const = 0;
		...
		//! sets a default size
		virtual void setSize(EGUI_DEFAULT_SIZE which, SINT32 size) = 0;
		...
		virtual UINT32 getIcon(EGUI_DEFAULT_ICON icon) const = 0;
		...
		virtual void setIcon(EGUI_DEFAULT_ICON icon, UINT32 index) = 0;
		...
		virtual void drawIcon(IGUIElement* element, EGUI_DEFAULT_ICON icon,
			const Position2d position, UINT32 starttime = 0, UINT32 currenttime = 0,
			bool loop = false, const rect<SINT32>* clip = 0) = 0;
		...
		virtual void draw2DRectangle(IGUIElement* element, const ColourValue &color,
			const rect<SINT32>& pos, const rect<SINT32>* clip = 0) = 0;
