#ifndef _SAPPHIRE_I_GUI_STATIC_TEXT_
#define _SAPPHIRE_I_GUI_STATIC_TEXT_
...
namespace Sapphire
{
	...
	public:
		...
		//! constructor
		IGUIStaticText(IGUIEnvironment* environment, IGUIElement* parent, SINT32 id, rect<SINT32> rectangle)
		...
		virtual void setOverrideColor(ColourValue color) = 0;

		//! Gets the override color
		/** \return: The override color */
		virtual ColourValue getOverrideColor(void) const = 0;
		...
		virtual void setBackgroundColor(ColourValue color) = 0;
		...
		virtual SINT32 getTextHeight() const = 0;
		...
		virtual SINT32 getTextWidth(void) const = 0;
