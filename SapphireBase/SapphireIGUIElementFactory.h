#ifndef _SAPPHIRE_I_GUI_ELEMENT_FACTORY_
#define _SAPPHIRE_I_GUI_ELEMENT_FACTORY_
...
namespace Sapphire
{
	...
	*/
	class IGUIElementFactory : public virtual IReferenceCounter
	{
	public:
		...
		virtual SINT32 getCreatableGUIElementTypeCount() const = 0;
		...
		virtual EGUI_ELEMENT_TYPE getCreateableGUIElementType(SINT32 idx) const = 0;
		...
		getCreatableGUIElementTypeCount() */
		virtual const c8* getCreateableGUIElementTypeName(SINT32 idx) const = 0;
