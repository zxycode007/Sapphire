#ifndef _SAPPHIRE_I_GUI_TREE_VIEW_
#define _SAPPHIRE_I_GUI_TREE_VIEW_
...
namespace Sapphire
{
	...
	*/
	class IGUITreeViewNode : public IReferenceCounter
	{
	public:
		...
		virtual void setImageIndex(UINT32 imageIndex) = 0;

		//! returns the image index of the node
		virtual UINT32 getSelectedImageIndex() const = 0;

		//! sets the image index of the node
		virtual void setSelectedImageIndex(UINT32 imageIndex) = 0;
		...
		virtual IReferenceCounter* getData2() const = 0;

		//! sets the user data2 (IReferenceCounter) of this node
		virtual void setData2(IReferenceCounter* data) = 0;
		...
		*/
		virtual IGUITreeViewNode* addChildBack(
			...
			SINT32 imageIndex = -1, SINT32 selectedImageIndex = -1,
			void* data = 0, IReferenceCounter* data2 = 0) = 0;
		...
		*/
		...
		virtual SINT32 getLevel() const = 0;
