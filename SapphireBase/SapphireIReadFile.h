#ifndef _SAPPHIRE_I_READ_FILE_
#define _SAPPHIRE_I_READ_FILE_
...
namespace Sapphire
{
	...
	class IReadFile : public virtual IReferenceCounter
	{
	public:
		...
		virtual SINT32 read(void* buffer, UINT32 sizeToRead) = 0;
