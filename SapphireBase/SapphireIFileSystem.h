#ifndef _SAPPHIRE_I_FILE_SYSTEM_
#define _SAPPHIRE_I_FILE_SYSTEM_

#include "SapphirePrerequisites.h"
#include "SapphireIReferenceCounter.h"
#include "SapphirePath.h"
#include "SapphireIXMLReader.h"
#include "SapphireIFileArchive.h"
...
namespace Sapphire
{
	...
	class IFileSystem : public virtual IReferenceCounter
	{
	public:
		...
		See IReferenceCounted::drop() for more information.
		*/
		virtual IReadFile* createMemoryReadFile(void* memory, SINT32 len, const path& fileName, bool deleteMemoryWhenDropped = false) = 0;
		...
		*/
		...
		See IReferenceCounted::drop() for more information.
		*/
		virtual IWriteFile* createMemoryWriteFile(void* memory, SINT32 len, const path& fileName, bool deleteMemoryWhenDropped = false) = 0;
		...
		virtual UINT32 getFileArchiveCount() const = 0;
		...
		virtual bool removeFileArchive(UINT32 index) = 0;
		...
		virtual bool moveFileArchive(UINT32 sourceIndex, SINT32 relative) = 0;

		//! Get the archive at a given index.
		virtual IFileArchive* getFileArchive(UINT32 index) = 0;
		...
		virtual UINT32 getArchiveLoaderCount() const = 0;

		//! Retrieve the given archive loader
		/** \param index The index of the loader to retrieve. This parameter is an 0-based
		array index.
		\return A pointer to the specified loader, 0 if the index is incorrect. */
		virtual IArchiveLoader* getArchiveLoader(UINT32 index) const = 0;
		...
		it has to be deleted using its IFileList::drop() method.
		See IReferenceCounted::drop() for more information. */
		virtual IFileList* createEmptyFileList(const path& path, bool ignoreCase, bool ignorePaths) = 0;
		...
		See IReferenceCounted::drop() for more information. */
		virtual IAttributes* createEmptyAttributes(IVideoDriver* driver = 0) = 0;
	};
