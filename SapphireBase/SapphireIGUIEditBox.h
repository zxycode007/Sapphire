#ifndef _SAPPHIRE_I_GUI_EDIT_BOX_
#define _SAPPHIRE_I_GUI_EDIT_BOX_
...
namespace Sapphire
{
	...
	*/
	...
	public:
		...
		//! constructor
		IGUIEditBox(IGUIEnvironment* environment, IGUIElement* parent, SINT32 id, rect<SINT32> rectangle)
		...
		virtual ColourValue getOverrideColor() const = 0;
		...
		virtual dimension2du getTextDimension() = 0;

		//! Sets the maximum amount of characters which may be entered in the box.
		/** \param max: Maximum amount of characters. If 0, the character amount is
		infinity. */
		virtual void setMax(UINT32 max) = 0;
