#ifndef _SAPPHIRE_I_SCENE_NODE_ANIMATOR_COLLISION_RESPONSE_
#define _SAPPHIRE_I_SCENE_NODE_ANIMATOR_COLLISION_RESPONSE_
...
namespace Sapphire
{
	...
	*/
	...
	public:
		...
		determine it:
		\code
		aabbox<FLOAT32> box = yourSceneNode->getBoundingBox();
