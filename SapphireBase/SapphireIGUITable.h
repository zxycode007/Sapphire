#ifndef _SAPPHIRE_I_GUI_TABLE_
#define _SAPPHIRE_I_GUI_TABLE_
...
namespace Sapphire
{
	...
	*/
	...
	public:
		//! constructor
		IGUITable(IGUIEnvironment* environment, IGUIElement* parent, SINT32 id, rect<SINT32> rectangle)
		...
		virtual void addColumn(const wchar_t* caption, SINT32 columnIndex = -1) = 0;

		//! remove a column from the table
		virtual void removeColumn(UINT32 columnIndex) = 0;

		//! Returns the number of columns in the table control
		virtual SINT32 getColumnCount() const = 0;
		...
		virtual bool setActiveColumn(SINT32 idx, bool doOrder = false) = 0;

		//! Returns which header is currently active
		virtual SINT32 getActiveColumn() const = 0;

		//! Returns the ordering used by the currently active column
		virtual EGUI_ORDERING_MODE getActiveColumnOrdering() const = 0;

		//! Set the width of a column
		virtual void setColumnWidth(UINT32 columnIndex, UINT32 width) = 0;

		//! Get the width of a column
		virtual UINT32 getColumnWidth(UINT32 columnIndex) const = 0;
		...
		virtual void setColumnOrdering(UINT32 columnIndex, EGUI_COLUMN_ORDERING mode) = 0;
		...
		virtual SINT32 getRowCount() const = 0;
		...
		virtual UINT32 addRow(UINT32 rowIndex) = 0;

		//! Remove a row from the table
		virtual void removeRow(UINT32 rowIndex) = 0;

		//! clears the table rows, but keeps the columns intact
		virtual void clearRows() = 0;

		//! Swap two row positions.
		virtual void swapRows(UINT32 rowIndexA, UINT32 rowIndexB) = 0;
		...
		virtual void orderRows(SINT32 columnIndex = -1, EGUI_ORDERING_MODE mode = EGOM_NONE) = 0;

		//! Set the text of a cell
		virtual void setCellText(UINT32 rowIndex, UINT32 columnIndex, const StringW& text) = 0;

		//! Set the text of a cell, and set a color of this cell.
		virtual void setCellText(UINT32 rowIndex, UINT32 columnIndex, const StringW& text,ColourValue color) = 0;

		//! Set the data of a cell
		virtual void setCellData(UINT32 rowIndex, UINT32 columnIndex, void *data) = 0;

		//! Set the color of a cell text
		virtual void setCellColor(UINT32 rowIndex, UINT32 columnIndex,ColourValue color) = 0;

		//! Get the text of a cell
		virtual const wchar_t* getCellText(UINT32 rowIndex, UINT32 columnIndex) const = 0;

		//! Get the data of a cell
		virtual void* getCellData(UINT32 rowIndex, UINT32 columnIndex) const = 0;

		//! clears the table, deletes all items in the table
		virtual void clear() = 0;

		//! Set flags, as defined in EGUI_TABLE_DRAW_FLAGS, which influence the layout
		virtual void setDrawFlags(SINT32 flags) = 0;

		//! Get the flags, as defined in EGUI_TABLE_DRAW_FLAGS, which influence the layout
		virtual SINT32 getDrawFlags() const = 0;
	};
