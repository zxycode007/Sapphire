#ifndef _SAPPHIRE_I_GUI_CONTEXT_MENU_
#define _SAPPHIRE_I_GUI_CONTEXT_MENU_
...
namespace Sapphire
{
	...
	*/
	...
	public:
		...
		//! constructor
		IGUIContextMenu(IGUIEnvironment* environment, IGUIElement* parent, SINT32 id, rect<SINT32> rectangle)
		...
		virtual UINT32 addItem(const wchar_t* text, SINT32 commandId = -1, bool enabled = true,
		...
		\param autoChecking: Specifies if the item should be checked by clicking
		\return Returns the index of the new item */
		virtual UINT32 insertItem(UINT32 idx, const wchar_t* text, SINT32 commandId = -1, bool enabled = true,
			bool hasSubMenu = false, bool checked = false, bool autoChecking = false) = 0;
		...
		virtual SINT32 findItemWithCommandId(SINT32 commandId, UINT32 idxStartSearch = 0) const = 0;
		...
		virtual const wchar_t* getItemText(UINT32 idx) const = 0;

		//! Sets text of the menu item.
		/** \param idx: Zero based index of the menu item
		\param text: New text of the item. */
		virtual void setItemText(UINT32 idx, const wchar_t* text) = 0;

		//! Check if a menu item is enabled
		/** \param idx: Zero based index of the menu item */
		virtual bool isItemEnabled(UINT32 idx) const = 0;

		//! Sets if the menu item should be enabled.
		/** \param idx: Zero based index of the menu item
		\param enabled: True if it is enabled, otherwise false. */
		virtual void setItemEnabled(UINT32 idx, bool enabled) = 0;

		//! Sets if the menu item should be checked.
		/** \param idx: Zero based index of the menu item
		\param enabled: True if it is enabled, otherwise false. */
		virtual void setItemChecked(UINT32 idx, bool enabled) = 0;

		//! Check if a menu item is checked
		/** \param idx: Zero based index of the menu item */
		virtual bool isItemChecked(UINT32 idx) const = 0;
		...
		virtual SINT32 getSelectedItem() const = 0;

		//! Get the command id of a menu item
		/** \param idx: Zero based index of the menu item */
		virtual SINT32 getItemCommandId(UINT32 idx) const = 0;

		//! Sets the command id of a menu item
		/** \param idx: Zero based index of the menu item
		\param id: Command id of menu item, a simple id you may
		set to whatever you want. */
		virtual void setItemCommandId(UINT32 idx, SINT32 id) = 0;

		//! Get a pointer to the submenu of an item.
		/** 0 is returned if there is no submenu
		\param idx: Zero based index of the menu item
		\return Returns a pointer to the submenu of an item. */
		virtual IGUIContextMenu* getSubMenu(UINT32 idx) const = 0;

		//! should the element change the checked status on clicking
		virtual void setItemAutoChecking(UINT32 idx, bool autoChecking) = 0;

		//! does the element change the checked status on clicking
		virtual bool getItemAutoChecking(UINT32 idx) const = 0;
