#ifndef _SAPPHIRE_I_FILE_ARCHIVE_
#define _SAPPHIRE_I_FILE_ARCHIVE_
...
namespace Sapphire
{
	...
	class IFileArchive : public virtual IReferenceCounter
	{
	public:
		...
		virtual IReadFile* createAndOpenFile(UINT32 index) = 0;
	...
	class IArchiveLoader : public virtual IReferenceCounter
	{
	public:
		...
		\param ignorePaths Files are searched for without checking for the directories
		\return Pointer to newly created archive, or 0 upon error. */
		virtual IFileArchive* createArchive(IReadFile* file, bool ignoreCase, bool ignorePaths) const = 0;
	};
}
